...
pub const ICON_ID_FILES: u8 = 1;
pub const ICON_ID_SEARCH: u8 = 2;
pub const ICON_ID_USERS: u8 = 3;
pub const ICON_ID_TERMINAL: u8 = 4;
pub const ICON_ID_GIT: u8 = 5;
pub const ICON_ID_EXTENSIONS: u8 = 6;
