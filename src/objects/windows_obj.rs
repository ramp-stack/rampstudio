...
use quartz::Canvas;
use quartz::{load_image_sized, tint_overlay, Align, Arc, Color, Font, Image, Span, Text};
...
pub fn setup(
    ...
    cv.add_game_object(
        ...
        GameObject::build("app_bg")
            ...
            .size(4000.0, 4000.0)
            .layer(-1)
            .image(tint_overlay(4000.0, 4000.0, COL_APP_BG))
            .finish(),
    );
    ...
    cv.add_game_object(
        ...
        GameObject::build("topbar_bg")
            .position(0.0, 0.0)
            .size(init_cw, TOPBAR_H)
            .layer(5)
            .image(tint_overlay(init_cw, TOPBAR_H, COL_TOPBAR_BG))
            .finish(),
    );
    ...
    cv.add_game_object(
        ...
        GameObject::build("topbar_sep")
            .position(0.0, TOPBAR_H)
            .size(init_cw, 1.0)
            .layer(6)
            .image(tint_overlay(init_cw, 1.0, COL_BORDER))
            .finish(),
    );
    ...
    cv.add_game_object(
        ...
        GameObject::build("topbar_logo")
            ...
            .size(LOGO_W, LOGO_H)
            .layer(7)
            .image(load_image_sized(
                include_bytes!("../../resources/rampstacklogo.png"),
                LOGO_W,
                LOGO_H,
            ))
            .finish(),
    ...
    cv.add_game_object(
        ...
        GameObject::build("icon_stacked")
            ...
            .layer(7)
            .image(load_image_sized(
                include_bytes!("../../resources/unselected_stacked.png"),
                ICON_SIZE,
                ICON_SIZE,
            ))
            .finish(),
    ...
    cv.add_game_object(
        ...
        GameObject::build("icon_sidebyside")
            ...
            .layer(7)
            .image(load_image_sized(
                include_bytes!("../../resources/selected_sidebyside.png"),
                ICON_SIZE,
                ICON_SIZE,
            ))
            .finish(),
    ...
    cv.add_game_object(
        ...
        GameObject::build("sidebar_bg")
            .position(0.0, panel_top)
            .size(SIDEBAR_W, panel_h)
            .layer(4)
            .image(tint_overlay(SIDEBAR_W, panel_h, COL_SIDEBAR_BG))
            .finish(),
    );

    cv.add_game_object(
        "sidebar_sep".into(),
        GameObject::build("sidebar_sep")
            .position(SIDEBAR_W, panel_top)
            .size(1.0, panel_h)
            .layer(4)
            .image(tint_overlay(1.0, panel_h, COL_BORDER))
            .finish(),
    );
    ...
    let mut file_obj = GameObject::build("sidebar_icon_files")
        ...
        .size(SIDEBAR_ICON_SIZE, SIDEBAR_ICON_SIZE)
        .layer(8)
        .finish();
    file_obj.set_drawable(Box::new(ph_text(
        PH_FILES,
        SIDEBAR_ICON_SIZE,
        SIDEBAR_ICON_COLOR,
        ph_light.clone(),
    ...
    let mut search_obj = GameObject::build("sidebar_icon_search")
        .position(
            icon_x,
            panel_top + SIDEBAR_ICON_TOP + SIDEBAR_ICON_SIZE + SIDEBAR_ICON_GAP,
        )
        .size(SIDEBAR_ICON_SIZE, SIDEBAR_ICON_SIZE)
        .layer(8)
        .finish();
    search_obj.set_drawable(Box::new(ph_text(
        PH_SEARCH,
        SIDEBAR_ICON_SIZE,
        SIDEBAR_ICON_COLOR,
        ph_light.clone(),
